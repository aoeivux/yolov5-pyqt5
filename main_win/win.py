...
"")
    ...
    def retranslateUi(self, mainWindow):
        ...
        mainWindow.setWindowTitle(_translate("mainWindow", "YOLOv5目标检测与实时识别"))
        self.label_4.setText(_translate("mainWindow", "基于YOLOv5的图像、视频、摄像头实时目标检测系统"))
        ...
        self.label_2.setText(_translate("mainWindow", "IoU交集比并集"))
        self.label.setText(_translate("mainWindow", "置信度调整"))
        self.label_8.setText(_translate("mainWindow", "延迟调整"))
        self.checkBox.setText(_translate("mainWindow", "开启"))
        self.saveCheckBox.setText(_translate("mainWindow", "自动保存"))
        self.label_11.setText(_translate("mainWindow", "目标检测识别结果展示"))
        self.label_6.setText(_translate("mainWindow", "展示界面"))
